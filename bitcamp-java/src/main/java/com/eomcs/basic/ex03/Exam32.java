...
public class Exam32 {
  public static void main(String[] args) {
    ...
    System.out.println(3.141592653589793D);  // 8바이트(double의 약자)
    System.out.println(3.141592653589793d);  // 8바이트 부동소수점   
    
    System.out.println(3.141592653589793F);  // 4바이트(float의 약자)
    System.out.println(3.141592653589793f);  // 4바이트 부동소수점

    // 부동소수점의 경우 큰 값을 작은 메모리에 넣더라도
    // 컴파일 오류가 발생하지 않는다. 그냥 값이 짤려서 들어갈 뿐이다.
    // 부동소수점이 그래서 위험하다. (정수같은 경우는 컴파일 오류)
